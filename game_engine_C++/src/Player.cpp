...
namespace SI3LN
{
	...
	Player::Player(float x, float y, SDL_Texture *texture, int screenWidth, int screenHeight)
		: Entity(x, y, PLAYER_PORTRAIT_SIZE, PLAYER_PORTRAIT_SIZE), texture(texture), screenWidth(screenWidth), screenHeight(screenHeight), speed(PLAYER_SPEED), lastShootTime(0), shootCooldown(200) // 200ms between shots
	{
